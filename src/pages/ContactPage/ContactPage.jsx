        ...
        <div className="container">
          <div className="hero-content">
            ...
            <p className="hero-description">
              Ready to transform your social media presence? We're here to help you achieve your marketing goals. 
              Drop us a line and let's discuss how we can grow your business together.
            </p>
          ...
          <div className="contact-container">
            ...
            <div className="contact-info">
              <div className="info-header">
                ...
                <p className="section-description">
                  Our team of social media experts is ready to help you create a winning strategy. 
              ...
              <div className="contact-details">
                <div className="contact-item">
                  ...
                  <div className="contact-text">
                    ...
                    <span className="contact-value">+45 34 58 47 43</span>
                    <span className="contact-note">Mon-Fri 9AM-6PM CET</span>
                  </div>
                </div>
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-text">
                    ...
                    <span className="contact-note">United Kingdom</span>
                  </div>
                </div>
              </div>
              
              <div className="socials-section">
                <h3 className="socials-title">Follow Our Journey</h3>
                <p className="socials-description">Stay updated with our latest campaigns and success stories</p>
            ...
            <div className="contact-form-section">
              <div className="form-header">
                ...
                <p className="section-description">
                  Tell us about your project and we'll get back to you with a personalized strategy 
            ...
            <div className="trust-badges">
              <div className="trust-badge">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <path d="M21 12c-1 0-2-.4-2.7-1.1C17.4 10.2 16 9.5 14.5 9.5c-1.5 0-2.9.7-3.8 1.4C9.8 11.6 9 12 8 12c-1 0-2-.4-2.7-1.1C4.6 10.2 3.2 9.5 1.7 9.5"/>
                </svg>
